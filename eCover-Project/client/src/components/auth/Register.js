...
//Register component // not use now
    ...
    <Fragment>
      ...
      <div style={{display: "flex"}}>
        <p className='' style={{marginRight: "5px"}}>
          If you wanna visit this site, you have to be a member of  
        </p>
        <a className='text-primary' href="https://atomicgains.com">Atomic Gains!</a>
      </div>
      <div style={{display: "flex"}}>
